...
namespace EWS.Common.Services
{
    public class EWSConstants
    {
        ...
        public static readonly ExtendedPropertyDefinition DatabaseIdPropertyDef;
        ...
        static EWSConstants()
        {
            ...
            DatabaseIdPropertyDef = new ExtendedPropertyDefinition(DefaultExtendedPropertySet.Meeting, // InternetHeaders,
